...
@cenum var"##Ctag#325"::UInt32 begin
...
@cenum var"##Ctag#326"::UInt32 begin
    IORING_MSG_DATA = 0
...
@cenum var"##Ctag#327"::UInt32 begin
...
@cenum var"##Ctag#329"::UInt32 begin
    IO_WQ_BOUND = 0
    IO_WQ_UNBOUND = 1
end
...
@cenum var"##Ctag#330"::UInt32 begin
...
const IOSQE_FIXED_FILE = Cuint(1) << IOSQE_FIXED_FILE_BIT

const IOSQE_IO_DRAIN = Cuint(1) << IOSQE_IO_DRAIN_BIT

const IOSQE_IO_LINK = Cuint(1) << IOSQE_IO_LINK_BIT

const IOSQE_IO_HARDLINK = Cuint(1) << IOSQE_IO_HARDLINK_BIT

const IOSQE_ASYNC = Cuint(1) << IOSQE_ASYNC_BIT

const IOSQE_BUFFER_SELECT = Cuint(1) << IOSQE_BUFFER_SELECT_BIT

const IOSQE_CQE_SKIP_SUCCESS = Cuint(1) << IOSQE_CQE_SKIP_SUCCESS_BIT
...
const LIBURING_UDATA_TIMEOUT = __u64(-1)

# exports
const PREFIXES = ["io_uring_"]
